...
export const apartmentsAdditionalFilters = [
   {
      ...
      type: 'list-single',
      options: [
         { value: 'liter1', label: 'Корпус 1' },
         { value: 'fdskmfds', label: 'афыаыфафы' },
      ],
      value: {},
   },
   {
      name: 'unique-offers',
      nameLabel: 'Уникальные предложения',
      type: 'list-multiple',
      options: [
         { value: 'test1', label: 'Кухня-столовая' },
         { value: 'test2', label: 'Готовая отделка' },
      ],
      value: [],
   },
   {
